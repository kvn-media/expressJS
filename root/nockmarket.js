...
app.configure(function () {
  ...
  app.use(express.session({secret: 'secretpasswordforsessions', store:
    nocklib.getSessionStore()}));
...
app.get('/portfolio', nocklib.ensureAuthenticated, 
  nockroutes.portfolio);
